...
public class QuizAuthor {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "quiz_author_gen")
    @SequenceGenerator(name = "quiz_author_gen", sequenceName = "quiz_author_seq", allocationSize = 1)
    ...
    @OneToMany(mappedBy = "quizAuthor", cascade = CascadeType.MERGE)
    private Set<QuizError> quizErrors = new HashSet<>();
