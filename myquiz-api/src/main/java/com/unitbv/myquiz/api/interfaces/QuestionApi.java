...
public interface QuestionApi {
    ...
    ResponseEntity<QuestionFilterDto> getQuestionsByQuizId(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved filtered questions"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ResponseEntity<QuestionFilterDto> listQuestionsFiltered(@RequestBody QuestionFilterInputDto filterInput);
